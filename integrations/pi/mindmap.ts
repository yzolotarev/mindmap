				...
				return {
					message: {
						...
						content: "**MINDMAP — Результат**\n\nСоединения юзера:\n```\n" + exp + "\n```\n\n" +
							...
							"Вставь вывод как есть, без пересказа. Под картинкой — максимум одна строка + один вопрос «почему?» " +
							"про ключевую стрелку юзера. В конце (если тема закрыта) предложи: углубить группу (Layer 2) или " +
